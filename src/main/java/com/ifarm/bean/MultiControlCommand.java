...
public class MultiControlCommand extends ControlCommand {
	...
	public MultiControlCommand(MultiControlTask wfmControlTask, String commandCategory, Integer controlDeviceId, Long collectorId) {
