...
import com.ifarm.bean.device.SoilTemHumDeviceValue;

@Component
public class SoilTemHumDeviceParse extends BaseCollectorDeviceParse{

	@Override
	public DeviceValueBase doParse(Long deviceId, byte[] arr) {
		DeviceValueBase deviceValueBase = new SoilTemHumDeviceValue();
